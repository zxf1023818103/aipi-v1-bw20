...
volatile struct _pwr_lmt_regu_remap pwrlmt_regu_remapping[1] = {
	{0x6, TXPWR_LMT_CN, TXPWR_LMT_CN}
};
...
const s8 tx_pwr_limit_2g_cn[4][14] = {
             {76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 76, 68, 68, 127}, /*CCK*/
             {72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 62, 60, 127}, /*OFDM*/
